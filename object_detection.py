    ...
    for box in boxes:
        ...
        if label >= 0:
            ...
            if tf:
                ...
                try:
                    playsound('F:/3.2/L 3200 system development/Crossing detection/siren2.wav')
                except:
                    pass
                cv2.waitKey(5)
                cv2.imwrite("F:\3.2\L 3200 system development\Crossing detection\Detected Images\violation_"+str(dcnt)+".jpg", cimg)
                dcnt = dcnt+1
            else:
...
weights_path = "F:/3.2/L 3200 system development/Crossing detection/yolov3.weights"
# set some parameters
net_h, net_w = 416, 416
